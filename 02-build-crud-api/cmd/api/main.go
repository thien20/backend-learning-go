...
import (
	...
	"github.com/thien/backend-learning-go/02-build-crud-api/internal/app"
)
...
func main() {
	...
	// TODO: Decide on a shutdown budget and which background work must finish
	// before the process exits. Graceful shutdown is more than calling Shutdown.
